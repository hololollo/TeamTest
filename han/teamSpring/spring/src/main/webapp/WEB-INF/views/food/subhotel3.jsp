 ...
 <%@ include file="../header.jsp" %>
    ...
    <main class="layout">
      <div class="breadcrumb">
        <p>
          <a href="${hpath }">홈</a><span><a href="${hpath }/food/fmain.do">숙박/음식점</a></span><span><a href="${hapth }/food/hotel.do">숙박정보</a></span><span>상세보기</span>
        </p>
      </div>
      ...
      <hr class="contents_hr">
        <div class="explain_table">
          <img src="${hpath }/resources/img/image-hotel/kumho.jpg" alt="금호 리조트">
            <table class="table1">
              <tbody>
                <tr>
                  <th>분 류</th>

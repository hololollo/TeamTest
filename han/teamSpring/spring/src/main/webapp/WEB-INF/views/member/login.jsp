...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; }
        ...
        .headerimg { width: 1930px; height: 600px; background-image: url(${path}/resources/img/login.png); margin: 0px auto; background-size: cover; background-position: center; background-repeat: no-repeat; }

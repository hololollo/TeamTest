    ...
    <main id="contents" class="clr-fix">
        <section>
            <div class="breadcrumb">
                <p>
                    <a href="${path}/index.jsp">홈</a><a href="${path}/tour.jsp">관광명소</a><span>속초 여름 해변 축제</span>
                </p>
            </div>
        </section>
        <hr>
            ...
            <div class="page_wrap">
                ...
                <div class="festivalinfo">
                    <div class="w3-content w3-display-container" id="festivalinfo">
                        ...
                        <img class="mySlides" src="${path}/resources/festival/img/summer_beach_festival1.png" alt="속초 여름 해변 축제 이미지">
                        <img class="mySlides" src="${path}/resources/festival/img/summer_beach_festival2.png" alt="속초 여름 해변 축제 이미지">
                        <img class="mySlides" src="${path}/resources/festival/img/summer_beach_festival3.png" alt="속초 여름 해변 축제 이미지">
                        <img class="mySlides" src="${path}/resources/festival/img/summer_beach_festival4.png" alt="속초 여름 해변 축제 이미지">
                ...
                <div class="textinfo">
                    ...
                    <p>속초 여름 해변 축제는 여름철 해변에서 즐길 수 있는 다양한 해양 스포츠와 축제가 열립니다.</p>
                </div>
                <div class="mapdiv">
                    ...
                    <script>
                        ...
                        marker.setMap(map);
                        var iwContent = '<div style="padding:5px;">속초 여름 해변 축제 위치 <br><a href="https://map.kakao.com/link/map/속초여름해변축제,38.207020,128.591960" style="color:blue" target="_blank">큰지도보기</a></div>', 

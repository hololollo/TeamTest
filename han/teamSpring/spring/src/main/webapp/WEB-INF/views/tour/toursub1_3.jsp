    ...
    <main id="contents" class="clr-fix">
        <section>
            <div class="breadcrumb">
                <p>
                    <a href="${path}/index.jsp">홈</a><a href="${path}/tour.jsp">관광명소</a><span>문화 예술 축제</span>
                </p>
            </div>
        </section>
        <hr>
            ...
            <div class="page_wrap">
                ...
                <div class="festivalinfo">
                    <div class="w3-content w3-display-container" id="festivalinfo">
                        <img class="mySlides" src="${path}/resources/img/festival/art_festival1.png" alt="문화 예술 축제 이미지">
                        <img class="mySlides" src="${path}/resources/img/festival/art_festival2.png" alt="문화 예술 축제 이미지">
                        <img class="mySlides" src="${path}/resources/img/festival/art_festival3.png" alt="문화 예술 축제 이미지">
                        <img class="mySlides" src="${path}/resources/img/festival/art_festival4.png" alt="문화 예술 축제 이미지">
                ...
                <div class="textinfo">
                    ...
                    <p>문화 예술 축제는 지역 예술가들이 참여하여 다양한 작품을 선보이고 공연을 펼치는 행사입니다.</p>
                </div>
                <div class="mapdiv">
                    ...
                    <script>
                        ...
                        marker.setMap(map);
                        var iwContent = '<div style="padding:5px;">속초 문화 예술 축제 위치 <br><a href="https://map.kakao.com/link/map/속초문화예술축제,38.207020,128.591960" style="color:blue" target="_blank">큰지도보기</a></div>', 

    ...
    <main id="contents" class="clr-fix">
        <section>
            <div class="breadcrumb">
                <p>
                    <a href="${path}/index.jsp">홈</a><a href="${path}/tour.jsp">관광명소</a><span>해맞이 축제</span>
                </p>
            </div>
        </section>
        <hr>
            ...
            <div class="page_wrap">
                ...
                <div class="festivalinfo">
                    <div class="w3-content w3-display-container" id="festivalinfo">
						<img class="mySlides" src="${path}/resources/img/festival/sunrise_festival1.png" alt="해맞이 축제 이미지">
						<img class="mySlides" src="${path}/resources/img/festival/sunrise_festival2.png" alt="해맞이 축제 이미지">
						<img class="mySlides" src="${path}/resources/img/festival/sunrise_festival3.png" alt="해맞이 축제 이미지">
                        <img class="mySlides" src="${path}/resources/img/festival/sunrise_festival4.png" alt="해맞이 축제 이미지">
                ...
                <div class="textinfo">
                    ...
                    <p>강원도 속초시 해맞이로 456</p>
                    <p class="textifop"><span class="material-symbols-outlined">auto_stories</span> 내용</p>
                    <p>해맞이 축제는 새해를 맞이하여 첫 일출을 보기 위해 많은 사람들이 모이며, 다양한 문화 공연과 불꽃놀이가 포함됩니다.</p>
                </div>
                <div class="mapdiv">
                    ...
                    <script>
                        ...
                        marker.setMap(map);
                        var iwContent = '<div style="padding:5px;">속초 해맞이 축제 위치 <br><a href="https://map.kakao.com/link/map/속초해맞이축제,38.207020,128.591960" style="color:blue" target="_blank">큰지도보기</a></div>', 

     ...
     <figure id="vs">
        ...
        <section>
            <div class="breadcrumb">
                <p>
                    <a href="${path}/index.jsp">홈</a><a href="${path}/tour.jsp">관광명소</a><span>외옹치 해수욕장</span>
                </p>
            </div>
        </section>
        <hr>
        <section class="page" id="page1">
            <h2 class="page_title">외옹치 해수욕장</h2>
            <div class="page_wrap">
                <div class="sidemenu">
                    <ul>
                ...
                <div class="festivalinfo">
                    <div class="w3-content w3-display-container" id="festivalinfo">
                        <img class="mySlides" src="${path}/resources/img/beach/oeongchi_beach1.png" alt="외옹치 해수욕장 이미지 1">
                        <img class="mySlides" src="${path}/resources/img/beach/oeongchi_beach2.png" alt="외옹치 해수욕장 이미지 2">
                        <img class="mySlides" src="${path}/resources/img/beach/oeongchi_beach3.png" alt="외옹치 해수욕장 이미지 3">
                        <img class="mySlides" src="${path}/resources/img/beach/oeongchi_beach4.png" alt="외옹치 해수욕장 이미지 4">
                    ...
                    <div class="textinfo">
                        ...
                        <p>외옹치 해수욕장은 아름다운 바다 경관과 해안 산책로로 유명한 해변입니다.</p>
                    </div>
                    <div class="mapdiv">
                        ...
                        <script>
                            ...
                            marker.setMap(map);
                            var iwContent = '<div style="padding:5px;">외옹치 해수욕장 위치 <br><a href="https://map.kakao.com/link/map/외옹치해수욕장,38.207020,128.591960" style="color:blue" target="_blank">큰지도보기</a></div>', 

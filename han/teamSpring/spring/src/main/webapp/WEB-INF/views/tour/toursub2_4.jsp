     ...
     <figure id="vs">
        ...
        <section>
            <div class="breadcrumb">
                <p>
                    <a href="${path}/index.jsp">홈</a><a href="${path}/tour.jsp">관광명소</a><span>장사 해수욕장</span>
                </p>
            </div>
        </section>
        <hr>
        <section class="page" id="page1">
            <h2 class="page_title">장사 해수욕장</h2>
            <div class="page_wrap">
                <div class="sidemenu">
                    <ul>
                ...
                <div class="festivalinfo">
                    <div class="w3-content w3-display-container" id="festivalinfo">
                        <img class="mySlides" src="${path}/resources/img/beach/sokcho_beach1.jpg" alt="속초 해수욕장 이미지 1">
                        <img class="mySlides" src="${path}/resources/img/jangsa_beach2.jpg" alt="장사 해수욕장 이미지 2">
                        <img class="mySlides" src="${path}/resources/img/jangsa_beach3.jpg" alt="장사 해수욕장 이미지 3">
                        <img class="mySlides" src="${path}/resources/img/jangsa_beach4.jpg" alt="장사 해수욕장 이미지 4">
                    ...
                    <div class="mapdiv">
                        ...
                        <script>
                            ...
                            marker.setMap(map);
                            var iwContent = '<div style="padding:5px;">장사 해수욕장 위치 <br><a href="https://map.kakao.com/link/map/장사해수욕장,38.207020,128.591960" style="color:blue" target="_blank">큰지도보기</a></div>', 

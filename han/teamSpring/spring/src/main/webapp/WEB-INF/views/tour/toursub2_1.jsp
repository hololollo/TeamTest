     ...
     <figure id="vs">
        ...
        <section>
            <div class="breadcrumb">
                <p>
                    <a href="${path}/index.jsp">홈</a><a href="${path}/tour.jsp">관광명소</a><span>속초 해수욕장</span>
                </p>
            </div>
        </section>
        <hr>
        <section class="page" id="page1">
            <h2 class="page_title">속초 해수욕장</h2>
            <div class="page_wrap">
                <div class="sidemenu">
                    <ul>
                        <li class="sidemenuli"><a href="${path}/tour/toursub2_1.do" class="sidemenulia">속초 해수욕장<span class="material-symbols-outlined" style="float: right;">add</span></a></li>
                        <li class="sidemenuli"><a href="${path}/tour/toursub2_2.do" class="sidemenulia">외옹치 해수욕장<span class="material-symbols-outlined" style="float: right;">add</span></a></li>
                        <li class="sidemenuli"><a href="${path}/tour/toursub2_3.do" class="sidemenulia">설악 해수욕장<span class="material-symbols-outlined" style="float: right;">add</span></a></li>
                        <li class="sidemenuli"><a href="${path}/tour/toursub2_4.do" class="sidemenulia">장사 해수욕장<span class="material-symbols-outlined" style="float: right;">add</span></a></li>
                    </ul>
                </div>
                <div class="festivalinfo">
                    <div class="w3-content w3-display-container" id="festivalinfo">
                        <img class="mySlides" src="${path}/resources/img/beach/sokcho_beach1.png" alt="속초 해수욕장 이미지 1">
                        <img class="mySlides" src="${path}/resources/img/beach/sokcho_beach2.png" alt="속초 해수욕장 이미지 2">
                        <img class="mySlides" src="${path}/resources/img/beach/sokcho_beach3.png" alt="속초 해수욕장 이미지 3">
                        <img class="mySlides" src="${path}/resources/img/beach/sokcho_beach4.png" alt="속초 해수욕장 이미지 4">
                    ...
                    <div class="textinfo">
                        ...
                        <p>강원도 속초시 해수욕장로 190</p>
                        <p class="textifop"><span class="material-symbols-outlined">auto_stories</span> 내용</p>
                        <p>속초 해수욕장은 깨끗한 백사장과 맑은 물이 특징이며, 여름철에 많은 관광객들이 찾는 인기 해변입니다.</p>
                    </div>
                    <div class="mapdiv">
                        ...
                        <script>
                            ...
                            marker.setMap(map);
                            var iwContent = '<div style="padding:5px;">속초 해수욕장 위치 <br><a href="https://map.kakao.com/link/map/속초해수욕장,38.207020,128.591960" style="color:blue" target="_blank">큰지도보기</a></div>', 

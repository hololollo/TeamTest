     ...
     <figure id="vs">
        ...
        <section>
            <div class="breadcrumb">
                <p>
                    <a href="${path}/index.jsp">홈</a><a href="${path}/tour.jsp">관광명소</a><span>청초호</span>
                </p>
            </div>
        </section>
        <hr>
        <section class="page" id="page1">
            <h2 class="page_title">청초호</h2>
            <div class="page_wrap">
                <div class="sidemenu">
                    <ul>
                ...
                <div class="festivalinfo">
                    <div class="w3-content w3-display-container" id="festivalinfo">
                        <img class="mySlides" src="${path}/resources/img/san/cheongcho1.png" alt="청초호 이미지 1">
                        <img class="mySlides" src="${path}/resources/img/san/cheongcho2.png" alt="청초호 이미지 2">
                        <img class="mySlides" src="${path}/resources/img/san/cheongcho3.png" alt="청초호 이미지 3">
                        <img class="mySlides" src="${path}/resources/img/san/cheongcho4.png" alt="청초호 이미지 4">
                    ...
                    <div class="mapdiv">
                        ...
                        <script>
                            ...
                            marker.setMap(map);
                            var iwContent = '<div style="padding:5px;">청초호 위치 <br><a href="https://map.kakao.com/link/map/청초호,38.207020,128.591960" style="color:blue" target="_blank">큰지도보기</a></div>', 

     ...
     <figure id="vs">
        ...
        <section>
            <div class="breadcrumb">
                <p>
                    <a href="${path}/index.jsp">홈</a><a href="${path}/tour.jsp">관광명소</a><span>설악산 국립공원</span>
                </p>
            </div>
        </section>
        <hr>
        <section class="page" id="page1">
            <h2 class="page_title">설악산 국립공원</h2>
            <div class="page_wrap">
                <div class="sidemenu">
                    <ul>
                ...
                <div class="festivalinfo">
                    <div class="w3-content w3-display-container" id="festivalinfo">
                        <img class="mySlides" src="${path}/resources/img/san/seoraksan1.png" alt="설악산 국립공원 이미지 1">
                        <img class="mySlides" src="${path}/resources/img/san/seoraksan2.png" alt="설악산 국립공원 이미지 2">
                        <img class="mySlides" src="${path}/resources/img/san/seoraksan3.png" alt="설악산 국립공원 이미지 3">
                        <img class="mySlides" src="${path}/resources/img/san/seoraksan4.png" alt="설악산 국립공원 이미지 4">
                    ...
                    <div class="textinfo">
                        ...
                        <p>설악산 국립공원은 대한민국에서 가장 유명한 산 중 하나로, 다양한 산책로와 등산로가 있습니다.</p>
                    </div>
                    <div class="mapdiv">
                        ...
                        <script>
                            ...
                            marker.setMap(map);
                            var iwContent = '<div style="padding:5px;">설악산 국립공원 위치 <br><a href="https://map.kakao.com/link/map/설악산국립공원,38.207020,128.591960" style="color:blue" target="_blank">큰지도보기</a></div>', 
